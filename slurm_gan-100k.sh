...
python src/statphy/data_factory.py      \
	...
	--samples 100000                      \
	--path "./data/simulation-100k"

python src/GAN/train.py \
	--data_path "./data/simulation-100k/L=128_p=0.5928.npz" \
	--batch_size 500 \
	--epochs 1000 \
	--noise_dim 100 \
	--save_dir ./data/models/gan-100k
